...
public class principalController implements Initializable {
	...
	private void adicionaCampo(MouseEvent e) {
		try {
			do {
				qtd = Integer
						.parseInt(JOptionPane.showInputDialog("Digite quantos conjuntos você deseja inicializar:"));
				if (qtd < 1 || qtd > 6)
	...
	private void complementar(MouseEvent e) {
		...
		if (!achou) {
			JOptionPane.showMessageDialog(null, "Conjunto digitado não encontrado");
		} else {
			escreveConj();
		}
	}
